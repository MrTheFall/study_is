...
public class ClientsController implements ClientsApi {
    ...
    @Override
    public ResponseEntity<com.krusty.crab.dto.generated.Client> registerClient(
    ...
    @Override
    @PreAuthorize("hasRole('Manager') or (hasRole('CLIENT') and authentication.principal.userId == #p0)")
    public ResponseEntity<com.krusty.crab.dto.generated.Client> updateClient(
            Integer clientId, ClientUpdateRequest clientUpdateRequest) {
    ...
    public ResponseEntity<Void> changeClientPassword(Integer clientId, ChangePasswordRequest changePasswordRequest) {
        ...
        clientService.changePassword(
                clientId, changePasswordRequest.getCurrentPassword(), changePasswordRequest.getNewPassword());

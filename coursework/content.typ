...
- #strong[PR-002] Система должна поддерживать работу минимум 30
  одновременных пользователей.

- #strong[PR-003] Система должна обновлять статус заказа и отображать
  изменения не позднее чем через 5 секунд.

- #strong[PR-004] Необходимо, чтобы система выдерживала нагрузку минимум 50 запросов в
  секунду.

- #strong[PR-005] Необходимо, чтобы интернет‑подключение имело

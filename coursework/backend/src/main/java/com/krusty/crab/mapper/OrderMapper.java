...
public interface OrderMapper {
    ...
    @Mapping(target = "createdByEmployeeId", expression = "java(entity.getCreatedByEmployee() != null ? entity.getCreatedByEmployee().getId() : null)")
    @Mapping(target = "acceptedByEmployeeId", expression = "java(entity.getAcceptedByEmployee() != null ? entity.getAcceptedByEmployee().getId() : null)")

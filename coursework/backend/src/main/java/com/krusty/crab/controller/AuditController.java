...
public class AuditController implements AuditApi {
    ...
    public ResponseEntity<List<com.krusty.crab.dto.generated.AuditLogEntry>> getAuditLogs(
            ...
            Integer offset) {
        log.info(
                "Getting audit logs, employeeId: {}, orderId: {}, action: {}, limit: {}, offset: {}",
                employeeId,
                orderId,
                action,
                limit,
                offset);
        List<com.krusty.crab.entity.EmployeeActionLog> logs =
                actionLogService.getLogs(employeeId, orderId, action, from, to, limit, offset);
